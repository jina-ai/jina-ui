...
const Filter = ({
  ...
  <div className="px-3 bg-blue-500 bg-opacity-10 border-2 border-blue-500 rounded flex flex-row items-center">
    <select
      value={current}
      ...
      {result.tags && (
        <div className="flex-1 flex flex-col p-3">
          ...
          <div className="flex flex-row items-center border-t mt-2 pt-2">
            ...
            <div className="px-4 py-1 bg-blue-600 rounded-full text-white cursor-pointer flex flex-row items-center text-sm">
