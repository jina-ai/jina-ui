    ...
    return (
        <div className="fixed bottom-0 w-full bg-gray-100 p-4 py-2">
            <div className="items-center flex fex-row">
                <div
                    className="justify-self-end self-end w-52 mt-4 flex flor-row items-center cursor-pointer hover:bg-gray-200 p-2 rounded-md tranistion-all duration-200">
                    <Image src={github} alt="github"/>
                    <span className="ml-2">View on Github</span>
                </div>
                <div className="text-lg flex-1 font-medium text-center">How it works</div>
                <ChevronUpIcon
                    onClick={toggleShow}
